...
module.exports = function() {
    return {
        ...
        lightbox: {
            sections: [
                {name: "description", height: 70, map_to: "text", type: "textarea", focus: true, placeholder:"Task Name"},
...
module.exports = function(gantt) {
    ...
    gantt.createTask = function (item, parent, index) {
        ...
        if (this.config.details_on_create) {
            ...
            this.refreshData();
            this.showLightbox(item.id, item);
        } else {
...
module.exports = function(gantt) {
    ...
    TextareaControl.prototype.render = function(sns) {
        ...
        return "<div class='gantt_cal_ltext' style='height:50px;'>"+
               "<textarea style='border:1px solid red' class='activeSaveButton' placeholder='Enter Task name' required>"+
               "</textarea></div>";
    };
...
module.exports = function(gantt) {
    ...
    TimeControl.prototype.render = function(sns) {
        ...
        if (sns.single_date) {
            ...
            html += "<span style='font-weight:normal; width:30px; font-size:10pt; float:left;'>&nbsp;-&nbsp; </span>";
        }
